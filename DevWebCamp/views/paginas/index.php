...
<section class="resumen">
    <div class="resumen__grid">
        ...
        <div class="resumen__bloque" data-aos="<?php aos_animacion(); ?>">
            <p class="resumen__texto resumen__texto--numero">182</p>
        ...
        <?php foreach ($ponentes as $ponente): ?>
            <div class="speaker" data-aos="<?php aos_animacion(); ?>">
                <picture>
                    ...
                    <img loading="lazy" width="200" height="300" src="<?php echo $_ENV['HOST'] . '/img/ponentes' . $ponente->imagen; ?>.jpg" alt="Imagen Ponente" class="speaker__imagen">
                </picture>
