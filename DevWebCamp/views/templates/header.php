<header class="header">
    <div class="header__contenedor">
        <nav class="header__navegacion">
            <?php if(is_auth()) { ?>
                ...
                <form method="POST" action="/logout" class="header__form">
                    <input type="submit" value="Cerrar Sesion" class="header__submit--logout">
                </form>
            <?php } else { ?>
        ...
        <div class="header__contenido">
            ...
            <p class="header__texto">Julio 16 - 17 - 2024</p>
...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            ...
            <a href="/workshop-conferencias" class="navegacion__enlace <?php echo pagina_actual('/workshop-conferencias') ? 'navegacion__enlace--actual': ''; ?>">Workshops/Conferencias</a>
